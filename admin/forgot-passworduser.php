...
if($query -> rowCount() > 0)
{
   ...
   foreach($results as $row)
   {
     ...
     try {
         ...
         $mail->Password   = 'enjxnbsehkqqtfbh';                               //SMTP password
         ...
         $mail->addReplyTo('no-reply@gmail.com', 'No Reply');
          ...
          $url="https://smartcityservice.azurewebsites.net/admin/fcngu.php?reset=$token&id=$id";
         //Content
         $mail->isHTML(true);                                  //Set email format to HTML
         $mail->Subject = 'OTP Verification for Smart City services';
         $mail->Body    = "<h1>You requested for a password Reset</h1>
                            Your OTP is : $otp <br><br>
                            <a href='$url'>Click me </a> to verify the OTP <br><br>
                            You can also copy this link and paste it in your Web Browser <br>
                            https://smartcityservice.azurewebsites.net/admin/fcngu.php?reset=$token&id=$id<br>
                            Best Regards<br><br>
                            Smart City Services";
...
<head>
  ...
  <title>Smart City Services | Forgot Password</title>
